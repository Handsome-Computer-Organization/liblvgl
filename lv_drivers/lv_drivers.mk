...
HEADERS += $(wildcard $(LVGL_DIR)/$(LV_DRIVERS_DIR_NAME)/*.h)
HEADERS += $(wildcard $(LVGL_DIR)/$(LV_DRIVERS_DIR_NAME)/indev/*.h)
HEADERS += $(wildcard $(LVGL_DIR)/$(LV_DRIVERS_DIR_NAME)/gtkdrv/*.h)
HEADERS += $(wildcard $(LVGL_DIR)/$(LV_DRIVERS_DIR_NAME)/display/*.h)
